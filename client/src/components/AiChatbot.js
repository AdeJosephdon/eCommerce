...
function AiChatbot({toggleAiChat}) {
  ...
  function handleFormSubmit(e) {
    ...
    generateBotResponse([...chatHistory, {role: "user", text: `Using the details provided above, please address this please address this query: ${userMessage}`}])
    }, 600);
  }
  // Form Ends here 
        ...
        <div className="chat-header">
          ...
          <div className="chat-footer">
            ...
            >
              ...
              <button><Icon icon="fluent-mdl2:up" width="24" height="24" /></button>
